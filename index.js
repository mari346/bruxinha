...
Modelo ${prefix}verify untuk para começar a usar bot.`
				...
				teks = `Estamos Perdendo Cornos,Adeus! @${num.split('@')[0]}👋`
  ...
  wait: '*⏳* Ok amore, aguarde um pouquinho...⏳',
  ...
  only: {
    ...
    ownerB: '*🚨* Este recurso é para *o meu dono*',

    admin: '*🚨* Este recurso é para *ADMIN GRUPO*',

    Badmin: '*🚨* Torne-o alpino *ADMIN !*',

    daftarB: `Olá amore, digite 👉 *${prefix}verify* para começar a usar bot`
...
//--Info bot
  ...
  ‣ *Proprietário* : Figurinhas_whatsapp
...
if (args.length < 1) return reply('*✍️* Digite o texto')
...
if (args.length < 1) return reply('*✍️* Digite o nome do seu zodíaco')
...
if (args.length < 1) return reply('*🕵️‍♀️* Insira uma consulta')
...
mentions('〘  *Chamando Todos os Cornos* 〙\n┏━━━━━━━━━━━━━━━━━━━━\n┠⊷'+teks+'┃━━━━━━━━━━━━━━━━━━━━\n┃────✪ menos de 5 msg é BAN✪────\n┗━━━━━━━━━━━━━━━━━━━━', members_id, true)
